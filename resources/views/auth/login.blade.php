...
<head>
    ...
    <title>MapProject | Daxil Ol</title>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">Hesaba Giriş</p>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group has-feedback">
                <input type="password" id="password" name="password" class="form-control" placeholder="Şifrə" required>
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div  style="margin-left: 19px;" class="checkbox icheck">
                        <label>
                            <input name="remember" type="checkbox"  {{ old('remember') ? 'checked' : '' }}>Məni Yadda Saxla
                        </label>
                    </div>
                </div>
                <!-- /.col -->
        ...
        <a href="{{route('password.request')}}" class="text-center">Şifrəni Unutmusunuz?</a><br>
        <a href="{{route('register')}}" class="text-center">Qeydiyyatdan Keçin</a>
