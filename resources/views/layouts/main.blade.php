...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{url('/')}}" class="logo">
            ...
            <span class="logo-lg"><b>Map</b>Project</span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/admin_Lte/image/profil_image/{{Auth::user()->avatar}}" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    ...
                                    <small>{{Auth::user()->father_name}} oglu</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
                                ...
                                <div class="pull-right">
                                    <a href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" class="btn btn-default btn-flat">Çıxış</a>
...
<!-- FastClick -->
<script src="{{asset('admin_Lte/js/fastclick.js')}}"></script>
<!-- AdminLTE App -->
